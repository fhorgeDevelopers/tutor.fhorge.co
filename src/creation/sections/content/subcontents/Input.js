...
export const Input = (props) => {
    ...
    const [recorded_url, setRecorderUrl] = useState(props.data.recorded_url);
    const [mobile_url, setMobileUrl] = useState(props.data.mobile_url);
    const [live_url, setLiveUrl] = useState(props.data.live_url);
    ...
    //audio data
    // const [audio_header, setAudioHeader] = useState(props.data.audio_header);
    // const [video_footer, setVideoFooter] = useState(props.data.video_footer);
                            ...
                            {(type === "VI") ? (
                                <>
                                    <div className='row'>
                                        ...
                                        <div
                                            className={`${(video_type === 'VI') || (video_type === 'YO') || (video_type === 'MP') ? 'col-lg-6' : 'd-none'} `}
                                        >
                                            <div className="form-group mb-3">
                                        ...
                                        <div
                                            className={`${(video_type === 'VI') || (video_type === 'YO') || (video_type === 'MP') ? 'd-none' : 'col-lg-6'} `}
                                        >
                                            <div className="form-group mb-3">
                                        ...
                                        <div
                                            className={`${(video_type === 'VI') || (video_type === 'YO') || (video_type === 'MP') ? 'd-none' : 'col-lg-12'} `}
                                        >
                                            <div className='row'>
